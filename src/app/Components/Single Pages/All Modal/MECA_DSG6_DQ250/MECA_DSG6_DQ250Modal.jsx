                ...
                <div className="xl:w-[500px] bg-white rounded-tr-[5px] border-l-[1px] border-gray-300 md:pb-0 pb-1 ">
                  ...
                  <div className="mt-2">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Audi, volkswagen, Skoda à partir de 2008
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-500 font-[500]">
                      ...
                      <p className="text-[18px] font-[500]">
                        <span className="text-[16px]">
                          02E-02E927770AD-02E927770AJ-02E927770AT-02E927770AQ,
                          02E927770AM-02E927770AL
                        </span>
                      </p>
                    </div>
                  </div>
                ...
                <div className="md:flex md:px-0 px-4 py-1 justify-between">
                  <div className="md:w-2/3 flex items-center gap-5 mt-2">
                    ...
                    <div className="">
                      ...
                      <h1 className="my-1">
                        Golf, Jetta, Passat, Scirocco, Touran, Sharan, Audi,
                        Seat, Skoda.
                      </h1>
                    </div>
                  </div>
...
export default MECA_DSG6_DQ250Modal;
