                  ...
                  <div className="mt-2">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Module de commande (calculateur DSG7 - DQ380/381)
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-500 font-[500]">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Audi Q3 Audi Q5 Seat Leon, Golf 7 Tiguan
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-500 font-[500]">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Codes défauts P1735 00 et P1736 00
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="bg-white border-t border-gray-300 rounded-b-[5px] xl:w-[950px] mx-auto md:pt-0 pt-5">
                <div className="md:flex md:px-0 px-4 py-1 justify-between">
                  <div className="md:w-1/2 flex items-center gap-5 mt-2">
                    ...
                    <div className="">
                      <p className="text-[15px] text-gray-500">Volkswagen</p>
                      <h1 className="my-1">
                        Audi Q3 Audi Q5 Seat Leon, Golf 7 Tiguan
                      </h1>
                    </div>
                      ...
                      {stock === 0 ? (
                        ...
                        <div className="w-full">
                          <div className="text-center">
                            <Link
                              target="_blank"
                              href="https://buy.stripe.com/6oE2bM1hu4d1dH26r6"
                            >
...
export default DSG7_dq381Modal;
