...
import ScenicDiesel from "./ScenicDiesel";

const ScenicModalButtons = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<ScenicDiesel />); // Set modal content to CaptureEssence
...
export default ScenicModalButtons;
