...
import DC4_DC0_DUSTERModal from "./DC4_DC0_DUSTERModal";

const DC4_DC0_DUSTERButton = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<DC4_DC0_DUSTERModal />); // Set modal content to CaptureEssence
...
export default DC4_DC0_DUSTERButton;
