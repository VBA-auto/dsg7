...
const imagesSlide = [
  "/images/mecadq2001.webp",
  "/images/mecadq2002.webp",
  "/images/dq200M-2.webp",
  "/images/dq200M-1.webp",
];

const MECA_DSG7_DQ200Modal = () => {
                ...
                <div className="md:flex md:px-0 px-4 py-1 justify-between">
                  <div className="md:w-2/3 flex items-center gap-5 mt-2">
                    ...
                    <div className="">
                      ...
                      <h1 className="my-1">
                        A1, A3, Q2, Golf 6/7, Polo, Passat B7, Tiguan, Touran,
                        Seat Ibiza, Leon, Superb, Fabia, Yeti
                      </h1>
                    </div>
                  </div>
                      ...
                      {stock === 0 ? (
                        ...
                        <div className="w-full">
                          <div className="text-center">
                            <Link
                              target="_blank"
                              href="https://buy.stripe.com/bIYeYy6BO10PgTecPw"
                            >
...
export default MECA_DSG7_DQ200Modal;
