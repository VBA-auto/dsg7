...
import DC4_DC0_MEGANEModal from "./DC4_DC0_MEGANEModal";

const DC4_DC0_MEGANEButton = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<DC4_DC0_MEGANEModal />); // Set modal content to CaptureEssence
...
export default DC4_DC0_MEGANEButton;
