...
import DSG7_dq381Modal from "./DSG7_dq381Modal";

const DSG7_dq381Button = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<DSG7_dq381Modal />); // Set modal content to CaptureEssence
    document.getElementById("DSG7_DQ381MODAL").showModal(); // Open the modal
  };
  ...
  return (
    <div>
      ...
      {/* Modal */}
      <dialog id="DSG7_DQ381MODAL" className="modal">
...
export default DSG7_dq381Button;
