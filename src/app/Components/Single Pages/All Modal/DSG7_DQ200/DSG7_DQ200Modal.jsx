                  ...
                  <div className="mt-2">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Module de commande (calculateur DSG7 – DQ200)
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-500 font-[500]">
                    ...
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Audi, volkswagen, Skoda à partir de 2014
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-[14px] text-gray-500 font-[500]">
                      ...
                      <p className="text-[18px] font-[500]">
                        Codes défauts P189C, P17BF, P0841, P177B
                      </p>
                    </div>
                  </div>
                </div>
                      ...
                      {stock === 0 ? (
                        ...
                        <div className="w-full">
                          <div className="text-center">
                            <Link
                              target="_blank"
                              href="https://buy.stripe.com/aEU2bMbW838XbyUaHn"
                            >
...
export default DSG7_DQ200Modal;
