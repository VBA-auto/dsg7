...
import DSG7_DQ200Modal from "./DSG7_DQ200Modal";

const DSG7_DQ200Button = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<DSG7_DQ200Modal />); // Set modal content to CaptureEssence
    document.getElementById("DSG7_DQ200MODAL").showModal(); // Open the modal
  };
  ...
  return (
    <div>
      ...
      {/* Modal */}
      <dialog id="DSG7_DQ200MODAL" className="modal">
...
export default DSG7_DQ200Button;
