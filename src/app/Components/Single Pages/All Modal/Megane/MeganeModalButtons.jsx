...
import MeganeDiesel from "./MeganeDiesel";
import MeganeEssence from "./MeganeEssence";

const MeganeModalButtons = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<MeganeEssence />); // Set modal content to CaptureEssence
    document.getElementById("ClioModal").showModal(); // Open the modal
  };

  const handleDiesel = () => {
    setModalContent(<MeganeDiesel />); // Set modal content to CaptureDiesel
    document.getElementById("ClioModal").showModal(); // Open the modal
  };
...
export default MeganeModalButtons;
