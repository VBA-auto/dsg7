...
import MECA_DSG6_DQ250Modal from "./MECA_DSG6_DQ250Modal";

const MECA_DSG6_DQ250Button = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<MECA_DSG6_DQ250Modal />); // Set modal content to CaptureEssence
    document.getElementById("MECA_DSG6_DQ250MODAL").showModal(); // Open the modal
  };
  ...
  return (
    <div>
      ...
      {/* Modal */}
      <dialog id="MECA_DSG6_DQ250MODAL" className="modal">
...
export default MECA_DSG6_DQ250Button;
