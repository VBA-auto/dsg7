...
import DW5_SCENIC_5Modal from "./DW5_SCENIC_5Modal";

const DW5_SCENIC_5Button = () => {
  const [modalContent, setModalContent] = useState(null); // State to manage modal content

  const handleEssence = () => {
    setModalContent(<DW5_SCENIC_5Modal />); // Set modal content to CaptureEssence
    document.getElementById("DW5_SCENIC_5Modal").showModal(); // Open the modal
  };
  ...
  return (
    <div>
      ...
      {/* Modal */}
      <dialog id="DW5_SCENIC_5Modal" className="modal">
...
export default DW5_SCENIC_5Button;
