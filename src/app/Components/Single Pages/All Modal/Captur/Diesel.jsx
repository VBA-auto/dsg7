                ...
                <div className="xl:w-[500px] bg-white rounded-tr-[5px] border-l-[1px] border-gray-300 md:pb-0 pb-1 ">
                  ...
                  <div className="mt-2">
                    <div className="px-4 mb-2">
                      <p className="text-gray-500 font-[500]">Désignation</p>
                    ...
                    <div className="px-4 mb-3">
                      <p className="text-gray-500 font-[500]">Description</p>
                      <p className="text-[18px] font-[500]">
                        Module de commande (calculateur) Renault Captur Diesel
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-gray-500 font-[500]">Compatibilité</p>
                    ...
                    <div className="px-4 mb-3">
                      <p className="text-gray-500 font-[500]">Garantie</p>
                      <p className="text-[18px] font-[500]">12 mois neuf</p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-gray-500 font-[500]">Véhicule</p>
                      <p className="text-[18px] font-[500]">
                        Captur 1.5 Diesel
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      ...
                      <p className="text-[18px] font-[500]">
                        Captur à partir de 2012
                      </p>
                    </div>
                    <div className="px-4 mb-3">
                      <p className="text-gray-500 font-[500]">Référence OE</p>
                      <p className="text-[18px] font-[500]">
                        A2C30743000 - 01 K00
                      </p>
                    </div>
